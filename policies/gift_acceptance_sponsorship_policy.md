...
Governs acceptance and acknowledgment of donations and business sponsorships, protecting donors' deductions and the corporation's tax posture.

## 2. What We Accept

Cash and cash equivalents; publicly documented in-kind goods and services useful to the Program; sponsorships under Section 4. The Board must approve before acceptance: real property, vehicles, securities, gifts with restrictions beyond the scholarship or trip programs, and any gift raising legal, safety, or reputational concerns. Gifts earmarked for a named student are not accepted (Student Accounts Policy §6).
...
The corporation acknowledges in-kind gifts by description only; valuation is the donor's responsibility. The Treasurer records a good-faith internal value for the books.
